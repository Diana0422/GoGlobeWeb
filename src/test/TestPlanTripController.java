...
class TestPlanTripController {
	...
	private static final String ORGANIZER_ID = "user@gmail.com";
	...
	private static final String TRIP_NAME = "TestViaggio";
	...
	void testSaveTripSuccessful() {
		...
		try {
			...
			Trip.deleteTrip(TRIP_NAME);
			assertEquals(true, b);
		} catch (DatabaseException e) {			
			String logStr = "testSaveTripSuccessful() SHOULD NOT throw exception "+e;
			Logger.getGlobal().log(Level.INFO, logStr);
		}		
	}
